...
public class MyCommandProvider {
	...
	public void show() {
		...
		IDrivingService drivingService = OSGiUtils.getService(context, IDrivingService.class,
		...
		if (drivingService == null)
			...
			try {
				System.out.println(String.format("|\t          Reference Speed: %d Km/h",
						((IL3_DrivingService) drivingService).getReferenceSpeed()));
			} catch (Exception e) {
			}

			try {
				System.out.println(String.format("|\tLongit. Security Distance: %d cms",
						((IL1_DrivingService) drivingService).getLongitudinalSecurityDistance()));
			} catch (Exception e) {
			}

			try {
				System.out.println(String.format("|\tLateral Security Distance: %d cms",
						((IL2_DrivingService) drivingService).getLateralSecurityDistance()));
			} catch (Exception e) {
			}
		...
		IDistanceSensor frontDistanceSensor = OSGiUtils.getService(context, IDistanceSensor.class,
				"(" + IIdentifiable.ID + "=FrontDistanceSensor)");
		...
		IDistanceSensor rearDistanceSensor = OSGiUtils.getService(context, IDistanceSensor.class,
				"(" + IIdentifiable.ID + "=RearDistanceSensor)");
		...
		IDistanceSensor rightDistanceSensor = OSGiUtils.getService(context, IDistanceSensor.class,
		...
		IDistanceSensor leftDistanceSensor = OSGiUtils.getService(context, IDistanceSensor.class,
				"(" + IIdentifiable.ID + "=LeftDistanceSensor)");
		...
		IDistanceSensor LIDAR_FrontDistanceSensor = OSGiUtils.getService(context, IDistanceSensor.class,
				"(" + IIdentifiable.ID + "=LIDAR-FrontDistanceSensor)");
		if (LIDAR_FrontDistanceSensor != null) {
			int distance = LIDAR_FrontDistanceSensor.getDistance();
			String sDistance = (distance != DistanceSensor.MAX_DISTANCE ? String.valueOf(distance) : "∞");
			System.out.println(String.format("|\tFront: %s cms", sDistance));
		}
		IDistanceSensor LIDAR_RearDistanceSensor = OSGiUtils.getService(context, IDistanceSensor.class,
				"(" + IIdentifiable.ID + "=LIDAR-RearDistanceSensor)");
		if (LIDAR_RearDistanceSensor != null) {
			int distance = LIDAR_RearDistanceSensor.getDistance();
			String sDistance = (distance != DistanceSensor.MAX_DISTANCE ? String.valueOf(distance) : "∞");
			System.out.println(String.format("|\t Rear: %s cms", sDistance));
		}
		IDistanceSensor LIDAR_RightDistanceSensor = OSGiUtils.getService(context, IDistanceSensor.class,
		...
		IDistanceSensor LIDAR_LeftDistanceSensor = OSGiUtils.getService(context, IDistanceSensor.class,
				"(" + IIdentifiable.ID + "=LIDAR-LeftDistanceSensor)");
		...
		ILineSensor rightLineSensor = OSGiUtils.getService(context, ILineSensor.class,
		...
		ILineSensor leftLineSensor = OSGiUtils.getService(context, ILineSensor.class,
				"(" + IIdentifiable.ID + "=LeftLineSensor)");
	...
	public void distance(String l, int distance) {
		...
		IDistanceSensor sensor = OSGiUtils.getService(context, IDistanceSensor.class,
				String.format("(id=%s)", sensorId));
		if (sensor != null)
